    ...
    <Card sx={{ m: 2, borderRadius: 3, maxWidth: 680 }}>
      <CardContent>
          ...
          <Table>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell sx={{ fontWeight: "bold", borderTop: "1px solid grey", borderBottom: "1px solid grey" }}>
                  <CurrencyPoundIcon sx={{ fontSize: "small" }} />{totalSubtotal.toFixed(2)}
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
        ...
        <Box sx={{ display: "flex", gap: 2, mt: 2 }}>
          ...
          <PDFDownloadLink
            document={<InvoicePdf sharedRows={sharedRows} totalWeight={totalWeight} totalSubtotal={totalSubtotal} />}
            fileName="invoice.pdf"
          >
            {({ loading }) => (
              <Button variant="outlined" sx={{ textTransform: "none", color: 'grey', borderColor: "primary.main", '&:hover,&.Mui-selected': { backgroundColor: "primary.main", color: "white" } }}>
